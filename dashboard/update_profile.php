...
$ins=$db->query("INSERT education_info(s_roll,degree_name,group_name,school_name,gpa,pass_year) VALUES ('$id','$dname','$gname','$iname','$gpa','$pyear')");
   }
